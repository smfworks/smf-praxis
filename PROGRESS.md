...
- **Version:** `0.27.0` (`hybridagent/__init__.py`; `pyproject.toml` reads it dynamically)
...
- **Current blocker:** None. Phase 5 implementation is local-only until the complete independent review and release-quality gate pass; no intermediate branch push.
