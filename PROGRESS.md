...
- **Version:** `0.28.14` (`hybridagent/__init__.py`; `pyproject.toml` reads it dynamically)
- **Active branch:** `main` (consolidation phase + vertical build-out merged locally; pending push)
...
- **Current WIP:** None — Active Memory Consolidation (Phase 6) + Forensic/Legal vertical build-out (Phase 7) both `passing`.
