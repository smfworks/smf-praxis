...
- **Version:** `0.26.16` (`hybridagent/__init__.py`; `pyproject.toml` reads it dynamically)
...
- **Current blocker:** complete superseding release gates, independent exact-head maker-checker review, and remote promotion for `0.26.16`; PP40 remains `in_progress` until all pass.
